...
public class Demo2 {
    public static void main(String[] args) {
        ...
        String outputPath = args.length == 2 ? args[1] : new File(inputPath).getParent() + "/output2.txt";

        Input input = new Input();input.input(inputPath);
        Shift shift = new Shift(input.getLineTxt());shift.shift();
        Alphabetizer alphabetizer = new Alphabetizer(shift.getKwicList());alphabetizer.sort();
        Output output = new Output(alphabetizer.getKwicList());output.output(outputPath);
